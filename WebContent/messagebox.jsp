...
<link rel='canonical' href='http://www.dadaedu.icoc.me/msgBoard.jsp'>
...
#module15 .formMiddle15 .formMiddleCenter15 {
	border: none;
}
...
#module15 .formBottom15 {
	display: none;
}

#module15 .formMiddle15 .formMiddleLeft15 {
	display: none;
}

#module15 .formMiddle15 .formMiddleRight15 {
	display: none;
}

#module15 .formBanner15 {
	display: none;
}

#module15 .contentLineIcon {
	*padding: 0;
}
...
<body class="g_body g_locale2052 g_cusSiteWidth">
	...
	<div id="g_main" class='g_main g_col9 ' style=''>
													...
													<tr>
														...
														<td valign="top" id="containerFormsCenter"
															...
															<div id="centerTopForms"
																...
																<div id='module15' _indexClass='formIndex1'
																	class='form form15 formIndex1 formStyle50 fk_bannerStyle0 modulePattern modulePattern60'
																	title='' style='' _side='0' _inTab='0' _inMulMCol='0'
																	_inFullmeasure='0' _autoHeight='1' _global='false'
																	_independent='false'>
																	<table class='formTop formTop15' cellpadding='0'
																		cellspacing='0'>
																		<tr>
																			<td class='left'></td>
																			<td class='center'></td>
																	...
																	<table class='formMiddle formMiddle15' style=''
																		cellpadding='0' cellspacing='0'>
																		<tr>
																			<td class='formMiddleLeft formMiddleLeft15'></td>
																			<td class='formMiddleCenter formMiddleCenter15'
																				valign='top'>
																				<div class='formMiddleContent formMiddleContent15  '
																					tabStyle='0'>
																					<div id='msgBoard15' class='msgBoard jz-msgBoard'>
																						<div id='msgAdd' class='msgAdd'>
																							<div class='g_tip msgTips'></div>
																							<div class='msgAddTitle'>发表您的留言：</div>
																							<div class='msgAddItem msgTitle'>
																								<div
																									style='height: 23px; line-height: 23px; width: 230px; float: left; margin-bottom: 4px;'>
																								...
																								<div
																									...
																									<table cellpadding='0' cellspacing='0'>
																										<tr>
																											<td width='60px'><div
																													class='msgBoard_overToPoint'>邮箱：</div></td>
																											<td style='white-space: nowrap;'><input
																												class='g_itext msg_ipt ' id='reqEmail'
																												name='邮箱' type='text' size='14' value=''
																												maxlength='50'></td>
																										</tr>
																									</table>
																								</div>
																								<div
																									...
																									<table cellpadding='0' cellspacing='0'>
																										<tr>
																											<td width='60px'><div
																													class='msgBoard_overToPoint'>电话：</div></td>
																											<td style='white-space: nowrap;'><input
																												class='g_itext msg_ipt ' id='reqPhone'
																												name='电话' type='text' size='14' value=''
																												maxlength='50'></td>
																										</tr>
																									</table>
																								</div>
																										...
																										<tr>
																											...
																											<td><div style='width: 180px;'>
																													<div style='float: left;'>
																														<input class='g_itext'
																															id='msgBoardCaptcha' style='width: 40px'
																															type='text' maxlength='4' />
																													</div>
																													<div style='float: left;'>
																														<img alt=''
																															onclick='Site.changeMsgBoardValidateCode()'
																															title='看不清，换一张' id='msgBoardCaptchaImg'
																															style='height: 24px; width: 80px; cursor: pointer'
																															src='validateCode.jsp?363' />
																													</div>
																												</div></td>
																										</tr>
																									</table>
																								</div>
																								<div class='j-clearfloat'></div>
																							</div>
																								...
																								<div style='margin-bottom: 4px;'>
																									<table width='100%' cellpadding='0'
																										...
																										<tr>
																											...
																											<td><div class='j-textareaWrap'>
																													<textarea class='g_textarea j-textarea'
																														id='reqContent' rows='3' cols='50'
																														style='width: 87%;' maxlength='10000'></textarea>
																												</div></td>
																										</tr>
																									</table>
																								</div>
																								<div class='msgAddButton'>
																									<table width='100%' cellpadding='0'
																										...
																										<tr>
																											...
																											<td><input class='g_ibutton'
																												extClass='g_ibutton' type='button'
																												onclick='Site.msgBoardAddMsg(false,15,0)'
																												value='提交留言'> <span class='g_minor'
																												style='float: left; padding-left: 5px; _float: none;'>留言需审核后才会显示</span>
																											</td>
																										</tr>
																									</table>
																								</div>
																			...
																			<td class='formMiddleRight formMiddleRight15'></td>
																		</tr>
																	</table>
																	<table class='formBottom formBottom15' cellpadding='0'
																		cellspacing='0'>
																		<tr>
																			<td class='left left15'></td>
																			<td class='center center15'></td>
																			<td class='right right15'></td>
																		</tr>
																	</table>
																	<div class='clearfloat clearfloat15'></div>
																</div>
															...
															<li class='J_footerItemSection footerItemSection'><table
																	...
																	<tr>
																		...
																		<td class='footerItemContainer-secondTd'><div
																				...
																				<div class='footerItemTop'>
																					<a title='' class='footerItemTopLink'
																						href='shopping.jsp' child='0'>购物车</a>
																				</div>
																				<div class='footerItemMiddle'>
																					<div class='footSplitline'></div>
																				</div>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = -1101763733;
	fk_sale.signupDays = 1;
	fk_sale.signupMinutes = 1927;
	...
	}else if(!false && !false&& 32 >= 24 && false){
		Site.logDog(200004,18);
		$(".siteAdvertisement_box").show();
	}else if(!false &&  32 >= 24 && false){
		Site.logDog(200004,18);
		$(".siteAdvertisement_box").show();
	}else if(!false &&  32 >= 24 && false){
...
$(function() {
	...
	// ajax统计
	Site.total({colId:9, pdId:-1, ndId:-1, sc:0, rf:"http://dadaedu.faisco.cn/msgBoard.jsp"});
	//前端性能数据上报
	Site.report();
...
Site.fixMsgBoardStyle(15);
$('#pagenation15').find('a').hover(function(){$(this).addClass('g_hover')}, function(){$(this).removeClass('g_hover')});
