...
<%
	...
	String intereString= user.getInterest();
	//String lasttimeString= user.getLastTime().toString();
 	String mobile= user.getMobileString();
 	String password= user.getPsw();
 	String score= user.getScoreString();
 	String sex= user.getSexString();
																	...
																	<table class='formMiddle formMiddle28' style=''
																		...
																		<tr>
																			...
																			<td class='formMiddleCenter formMiddleCenter28'
																				valign='top'>
																				<form action="changeMessageServlet"
																					onsubmit="return validataForm();" method="post">
																					<table>
																						<tr>
																							<td>用户名</td>
																							<td><%=username %></td>
																						...
																						<tr>
																							...
																							<td><input type="text" name="interest"
																								id="interest" value="<%=intereString%>"></td>

																						</tr>

																						<tr>
																							<td><span
																								style="color: red; font-size: 13px;" id="td2"><%=errorMessage %></span>
																							<!-- 姝ゅ��剧ず���″�ㄧ��浼��ョ����璇�淇℃�� --></td>
																						</tr>
																						<tr>
