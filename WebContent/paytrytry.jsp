...
<link rel='canonical'
	href='http://www.dadaedu.icoc.me/mdetail.jsp?id=101'>
...
<link type='text/css'
	href=http://2.ss.faisys.com/css/mDetail.min.css?v=201607111726
	rel='stylesheet' />
<link type='text/css'
...
<body class="g_body g_locale2052 g_cusSiteWidth">
	<div id="memberBarArea" class="memberBarArea g_editPanel">
		...
		<div id="memberBar" class="memberBar">
			<div class="m_left">
				<a class='memberHeadPicOuter' href='mCenter.jsp'><img
					id='topBarMemberPic' class='msgBoard_member_headpic'
					src='http://0.ss.faisys.com/image/tx1.png' style="height: 30px"></a>
				<a href='privation.html'><span class="userLabel" title="等级：普通会员">大大用户</span></a>
				<span class="user_level_icon"
					style='position: relative; margin-top: 12px;'></span> <a
					href='mainweb.html' class="exit">[退出]</a>
			</div>
									...
									<tr valign='top'>
										...
										<td class="containerMiddleCenter">
											...
											<div id="containerForms" class="containerForms">
																	...
																	<div class='formWrap formWrap404'>
																						...
																						<tr>
																							...
																							<td class='titleCenter titleCenter404'
																								...
																								<div class='titleText titleText404'>
																									<span class='fk_mainTitle mainTitle404'>订单详情</span>
																								</div>
																							</td>
																		...
																		<table class='formMiddle formMiddle404' style=''
																			...
																			<tr>
																							...
																							<table class='g_foldContainerContent'
																								...
																								<tr>
																									...
																									<td class='g_foldContainerContentCenter'>
																										...
																										<table foldId='34'
																											...
																											<form action="<c:url value='/payServlet'/>">
																												商品订单号：<input type="text" value='20160714101'
																													readonly name="p2_Order"><br /> 支 付
																												金 额：<input type="text" value='0.1' readonly
																													name="p3_Amt"><br /> 选择银行：<br />
																												中国农业银行<input type="radio" name="pd_FrpId"
																													value="ABC-NET-B2C"> 建设银行<input
																													type="radio" name="pd_FrpId"
																													value="CCB-NET-B2C"><br /> <input
																										...
																										<table class='formBottom formBottom28'
																											cellpadding='0' cellspacing='0'>
																											<tr>
																									...
																									<td valign="top" id="containerFormsRight"
																										class="containerFormsRight"
																										style='display: none'>
																										<div class="containerFormsRightTop"></div>
																										<div id="rightForms"
																											class="column forms sideForms rightForms">
																				...
																				<td id="containerMiddleRight"
																					class="containerMiddleRight"></td>
																			</tr>
																		</table>
												...
												<table class="absBottomTable" cellpadding="0"
													cellspacing="0">
													<tr>
														<td align="center">
														...
														<td align="center" valign="top">
															...
															<div id="webFooter" class="webFooter">
																...
																<div id='footer' class='footer'>
																	<table class='footerTop' cellpadding='0'
																		cellspacing='0'>
																		<tr valign='top'>
																			<td class='topLeft'></td>
																	...
																	<table class='footerMiddle' cellpadding='0'
																		cellspacing='0'>
																		<tr valign='top'>
																			...
																			<td class='middleCenter' align='center'><div
																					class='footerContent'>
																					<div id='footerNav'
																						class='footerNav  footerPattern1' cusheight='0'>
																						<div class='footerItemListBox'>
																							<ul
																								class='footerItemListContainer J_footerItemListContainer'>
																								<li
																									class='J_footerItemSection footerItemSection'><table
																									...
																									class='J_footerItemSection footerItemSection'><table
																										...
																										<tr>
																											...
																											<td class='footerItemContainer-secondTd'><div
																													...
																													<div class='footerItemTop'>
																														<a title='' class='footerItemTopLink'
																															href='subject.html' target='_blank'
																															child='0'>科目查询</a>
																													</div>
																													<div class='footerItemMiddle'>
																														<div class='footSplitline'></div>
																									...
																									class='J_footerItemSection footerItemSection'><table
																										...
																										<tr>
																											...
																											<td class='footerItemContainer-secondTd'><div
																													...
																													<div class='footerItemTop'>
																														<a title='' class='footerItemTopLink'
																															href='classes.html' target='_blank'
																															child='0'>资源类别</a>
																													</div>
																													<div class='footerItemMiddle'>
																														<div class='footSplitline'></div>
																					...
																					<div class='footerSupport' id='footerSupport'>
																						<span class='footerMobile'><a
																							hidefocus='true' href='www.baidu.com'
																							target='_blank'>手机版</a></span> <span class='footerSep'>|</span>
																						<span class='footerFaisco'>本站使用<a
																							hidefocus='true'
																	...
																	<table class='footerBottom' cellpadding='0'
																		cellspacing='0'>
																		<tr valign='top'>
											...
											<div class="floatLeftTop">
												<div id="floatLeftTopForms"
													class="forms sideForms floatForms"></div>
											</div>
											<div class="floatRightTop">
												<div id="floatRightTopForms"
													class="forms sideForms floatForms"></div>
											</div>
											<div class="floatLeftBottom">
												<div id="floatLeftBottomForms"
													class="forms sideForms floatForms"></div>
											</div>
...
function showYuanDanWindow(){
	...
	fk_sale.popupWindowMs = -1117402227;
	fk_sale.signupDays = 1;
	fk_sale.signupMinutes = 2188;
...
$(function() {
	...
	// ajax统计
	Site.total({colId:-1, pdId:-1, ndId:-1, sc:0, rf:"http://www.dadaedu.icoc.me/mstl.jsp?imme"});
	//前端性能数据上报
	Site.report();
...
Site.initPayOrder(101);
Site.showContacterExtMsg(26);Site.initOrderSuc(26);
