				...
				<tr>
					<td align="center">
						<div id="webNav" class="webNav webNavDefault">
							...
							<a href='/col.jsp?id=110' style='display: none;'>1</a><a
								href='/col.jsp?id=111' style='display: none;'>2</a><a
								href='/col.jsp?id=112' style='display: none;'>3</a><a
								href='/col.jsp?id=113' style='display: none;'>4</a><a
								href='/col.jsp?id=114' style='display: none;'>5</a><a
								href='/col.jsp?id=115' style='display: none;'>6</a><a
								href='/col.jsp?id=116' style='display: none;'>7</a><a
								href='/col.jsp?id=117' style='display: none;'>8</a><a
								href='/col.jsp?id=118' style='display: none;'>9</a><a
								href='/col.jsp?id=119' style='display: none;'>10</a><a
								href='/col.jsp?id=120' style='display: none;'>11</a><a
								href='/col.jsp?id=121' style='display: none;'>12</a>
						</div>
					</td>
				</tr>
			</table>
														...
														<td valign="top" id="containerFormsCenter"
															...
															<div id="centerTopForms"
																...
																<div id='module404' _indexClass='formIndex1'
																	class='form form404 formIndex1 formStyle26 fk_bannerStyle0'
																	...
																	<table class='formBanner formBanner404' cellpadding='0'
																		cellspacing='0'>
																		<tr>
																		...
																		<tr>
																			...
																			<td class='formMiddleCenter formMiddleCenter404'
																				...
																				<div
																					...
																					tabStyle='0'>
																					<div
																						class=' g_foldContainer g_vertFold g_foldNOBtn g_groupFold'>
																						...
																						<table class='g_foldContainerContent'
																							...
																							<tr>
																								...
																								<td class='g_foldContainerContentCenter'>
																									<table class='g_foldContainerPanel'
																										cellpadding='0' cellspacing='0'>
																										<tr>
																											...
																											<td class='g_foldContainerPanelCenter'>
																												<table foldId='0'
																													...
																													<tr>
																														<td
																															class='productFilterValueLeft contentLineIcon'></td>
																														<td class='g_foldContainerValueCenter '
																															style='*padding: 0;'><span
																															style='cursor: default;'>全部分类</span></td>
																														<td class='g_foldContainerValueRight'></td>
																													</tr>
																												</table>
																												<div id='childrenDiv0M404'
																													class='g_foldContainerValuePanel '>
																													<div
																														class='g_foldSepLine g_foldPLine g_separator'></div>
																													<table foldId='30'
																														class='g_foldContainerValue g_foldContainerValue2 g_item fold_J fold_h_J'
																														cellpadding='0' cellspacing='0'>
																														<tr>
																															<td class='g_foldContainerValueLeft'></td>
																															<td class='g_foldContainerValueCenter '
																																style='*padding: 0;'><a
																																hidefocus='true' href='shipin.get'
																																title='视频区'>视频区</a></td>
																															<td class='g_foldContainerValueRight'></td>
																														</tr>
																													</table>
																													...
																													<table foldId='33'
																														...
																														<tr>
																															...
																															<td class='g_foldContainerValueCenter '
																																style='*padding: 0;'><a
																																hidefocus='true' href='yinpin.get'
																																title='音频区'>音频区</a></td>
																															<td class='g_foldContainerValueRight'></td>
																														</tr>
																													</table>
																	...
																	<table class='formBottom formBottom404' cellpadding='0'
																		cellspacing='0'>
																		<tr>
																			<td class='left left404'></td>
																...
																<div id='module22' _indexClass='formIndex2'
																	class='form form22 formIndex2 formStyle70 fk_bannerStyle0'
																	title='' style='' _side='0' _inTab='0' _inMulMCol='0'
																	_inFullmeasure='0' _autoHeight='1' _global='false'
																	_independent='false'>
																	...
																	<table id="mytable" class='formMiddle formMiddle22'
																		...
																		<tr>
																			...
																			<td class='formMiddleCenter formMiddleCenter22'
																				valign='top'>
																				<div class='formMiddleContent formMiddleContent22  '
																					tabStyle='0'>
																								...
																								<tr id='module22product60'>
																									...
																									<td id='productNameTd60' class='productNameTd'
																										...
																										<div class='propDiv propAlignLeft productName'>
																											<a hidefocus='true'
																												href='<%=web.getUrl()%>' target='_blank'><%=web.getTagname()%></a>
																										</div>
																									</td>
																								</tr>
																							</table>
												...
												<div class='footerSupport' id='footerSupport'>
													<span class='footerMobile'><a hidefocus='true'
														...
														onclick='Site.logDog(100065, 0);' target='_blank'> <span
															...
															style='padding-left: 2px; padding-right: 2px; position: relative; top: 2px;'></span>HTML5
													</a> <span style='padding-left: 8px;'>搭建</span></span> <span
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			Site.total({
				...
				ndId : -1,
				sc : 0,
				rf : "http://www.dadaedu.icoc.me/index.jsp"
			});
			//前端性能数据上报
			Site.report();
			...
			Site.productResultPropFilterSearch({
				"mul" : true,
				"lid" : 1
			});
			$('.fp_select_tab').hide();
			Site.productResultPriceCondFilter({
				"mul" : true,
				"lid" : 1
			});
			Site.initModuleProductResultPropFilter(22);
			$('#pagenation22').find('a').hover(function() {
				$(this).addClass('g_hover')
			}, function() {
				$(this).removeClass('g_hover')
			});
			Site.loadProductTile(22, true, false);
			Site.initContentSplitLine(22, {
				"y" : 0,
				"s" : 0,
				"w" : 1
			});
			...
			"l" : [
					{
						...
						"w" : 1900,
						"h" : 400,
						"tp" : "http://10308282.s21i-10.faiusr.com/2/ABUIABACGAAg3eiWvAUo8LOhkAIw7A44kAM!100x100.jpg"
					},
					{
						...
						"w" : 1900,
						"h" : 400,
						"tp" : "http://10308282.s21i-10.faiusr.com/2/ABUIABACGAAgyeiWvAUokNXNqgMw7A44kAM!100x100.jpg"
					},
					{
		...
		$(document)
				.ready(
						function display() {
							...
							document.getElementById("btn0").innerHTML = "当前 "
									+ curPage + "/" + page + " 页    每页 "; // 显示当前多少页
							document.getElementById("sjzl").innerHTML = "数据总量 "
									+ len + ""; // 显示数据量
							...
							$("#pageSizeSet")
									.click(
											function setPageSize() { // 设置每页显示多少条记录
												pageSize = document
														.getElementById("pageSize").value; //每页显示的记录条数
												if (!/^[1-9]\d*$/
														.test(pageSize)) {
													alert("请输入正整数");
													return;
